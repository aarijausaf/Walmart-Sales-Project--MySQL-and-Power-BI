...
For the rest of the code, check the [WalmartSales SQL Query.sql] (https://github.com/aarijausaf/Walmart-Sales-Project--MySQL-and-Power-BI/blob/main/WalmartSales%20SQL%20Query) file
